  ...
  return (
    <div className="">
      ...
      <div className="relative">
        <section className="w-full max-w-[1280px] mx-auto px-4 my-6 xl:my-20">
      ...
      {/*-------------------- Shop section ------------------------- */}
      <div className='w-full max-w-[1280px] px-4 mx-auto xl:my-20'>
      ...
      <div className="">
        <section className="w-full max-w-[1280px] px-4 mx-auto xl:my-20">
      ...
      {/*-------------------- what clients say ------------------------- */}
      <div className="">
        <section className="w-full max-w-[1280px] px-4 mx-auto mb-10 xl:my-20">
          <ClientSay />
        </section>
      </div>
