      ...
      <div className='w-full max-w-[1280px] px-2 mx-auto space-y-6 pt-10 pb-28'>
        ...
        <div className='flex justify-start items-center gap-8 p-10 bg-secondary'>
          <div className='relative'>
            <img src={profile02} alt="My Profile" className='w-full max-w-[130px] h-full max-h-[130px] rounded-full' />
          ...
          <div className='space-y-3'>
            ...
            <h3 className='md:text-2xl font-semibold text-opacity-80 text-font01'>Rudaba Jaman</h3>
          </div>
        </div>
        ...
        <div className='w-full max-w-[600px] mx-auto space-y-5'>
          ...
          <div className='p-3 w-full shadow-[2px_2px_10px_rgba(0,0,0,0.25)]'>
