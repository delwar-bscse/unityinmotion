...
const ProductCart = ({singleProduct}) => {
  ...
  return (
    <Link to={`/shop/${singleProduct.id}`} className='border-2 border-gray-200 p-5 group block'>
      ...
      <div className='flex justify-center items-center my-10 md:my-16 w-full h-[220px] overflow-hidden'>
        <img src={singleProduct?.productImg} alt="product image" className='w-full h-auto scale-90  group-hover:scale-100 transition-all duration-300' />
      </div>
